...
global nj ny replrate gridx tau
...
ret = 0.02; %0.024791;     %Guess on the rate of return !!!!%%%%%%%%%%%%%%%%%%%%%%
% SOLUTION
...
% if replrate==0
%     save v0_1.txt v0 -ascii -double 
%     save x0_1.txt x -ascii -double
% else
%     save vT_1.txt v0 -ascii -double 
%     save xT_1.txt x -ascii -double
% end
...
global betta tetta nj jr nx ny pi gridy netw pens sr epsi curv pini frac pop totpop grdfac delta alpha L R replrate
...
global L R replrate delta gridx tau
...
global betta tetta nj nx ny pi gridy pens sr epsi curv grdfac tau replrate
