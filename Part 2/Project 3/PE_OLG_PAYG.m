...
x=squeeze(gridx(1,:,:));
     ...
     save vT_dec.txt v0 -ascii -double 
     save xT_dec.txt x -ascii -double
...
global betta tetta r nj jr nx ny pi gridy netw pens sr epsi curv pini frac pop totpop grdfac L R
